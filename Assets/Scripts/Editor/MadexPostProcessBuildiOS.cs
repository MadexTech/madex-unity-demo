...
{
    public class MadexPostProcessBuildiOS
    {
        ...
        {
            "MadexSDK.xcframework",
            "SspnetCore.xcframework",
            "SspnetDsp.xcframework",

            "MadexConsentManager.xcframework",
        ...
        public static void MadexPostProcessPbxProject(BuildTarget buildTarget, string buildPath)
        {
